#' @title Pakistan Demographic and Health Survey 2012-13 Household Member Recode Data
#' @name  PKPR61
#' @description \code{PKPR61} data of Household Member Recode from Pakistan Demographic and Health Survey 2012-13.
#' \describe{
...
#'     \item{\code{sh13}}{Highest grade completed}
#'     \item{\code{sh15}}{Grade attending this year}
#'     \item{\code{sh16}}{Reasons for not attending school}
#'     \item{\code{sh21}}{Registered with NADRA}
#'     \item{\code{sh22}}{Born in this village/city}
#'     \item{\code{sh23u}}{Place moved from to this village/city: Unit}
#'     \item{\code{sh23n}}{Place moved from to this village/city: Code}
#'     \item{\code{sh24}}{Year when first move to this village/city}
#'     \item{\code{sh25}}{Primary reason of migration to this village/city}
