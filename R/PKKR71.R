#' @title Pakistan Demographic and Health Survey 2017-18 Children's Recode Data
#' @name  PKKR71
#' @description \code{PKKR71} data of Children's Recode from Pakistan Demographic and Health Survey 2017-18.
#' \describe{
...
#'     \item{\code{B17}}{Day of birth}
#'     \item{\code{B18}}{Century Day Code of birth (CDC)}
#'     \item{\code{B19}}{Current age of child in months (months since birth for dead children)}
#'     \item{\code{B20}}{NA - Duration of pregnancy}
...
#'     \item{\code{M2G}}{Prenatal: traditional birth attendant (DAI-TBA)}
#'     \item{\code{M2H}}{Prenatal: Lady H. Worker}
...
#'     \item{\code{M3B}}{Assistance: Nurse}
#'     \item{\code{M3C}}{Assistance: Midwife}
#'     \item{\code{M3D}}{Assistance: Lady health visitor}
#'     \item{\code{M3E}}{Assistance: Community midwife}
#'     \item{\code{M3F}}{NA - Assistance: CS health professional}
#'     \item{\code{M3G}}{Assistance: dai/traditional birth attendant}
#'     \item{\code{M3H}}{Assistance: Family welfare wk}
#'     \item{\code{M3I}}{Assistance: Lady h  worker}
...
#'     \item{\code{M17A}}{Timing on decision for caesarean section}
...
#'     \item{\code{M42A}}{NA - During pregnancy: weighed}
...
#'     \item{\code{M43}}{NA - Told about pregnancy complications}
...
#'     \item{\code{M54}}{NA - Received Vitamin A dose in first 2 months after delivery}
#'     \item{\code{M55}}{Given child anything other than breast milk}
#'     \item{\code{M55A}}{NA - First 3 days, given milk (other than breast milk)}
#'     \item{\code{M55B}}{NA - First 3 days, given plain water}
#'     \item{\code{M55C}}{NA - First 3 days, given sugar/glucose water}
#'     \item{\code{M55D}}{NA - First 3 days, given gripe water}
#'     \item{\code{M55E}}{NA - First 3 days, given sugar/salt solution}
#'     \item{\code{M55F}}{NA - First 3 days, given fruit juice}
#'     \item{\code{M55G}}{NA - First 3 days, given infant formula}
#'     \item{\code{M55H}}{NA - First 3 days, given tea/infusions}
#'     \item{\code{M55I}}{NA - First 3 days, given honey}
#'     \item{\code{M55J}}{NA - First 3 days, given coffee}
#'     \item{\code{M55K}}{NA - First 3 days, given country specific}
#'     \item{\code{M55L}}{NA - First 3 days, given country specific}
#'     \item{\code{M55M}}{NA - First 3 days, given country specific}
#'     \item{\code{M55N}}{NA - First 3 days, given country specific}
#'     \item{\code{M55O}}{NA - First 3 days, given country specific}
#'     \item{\code{M55X}}{NA - First 3 days, given other}
#'     \item{\code{M55Z}}{NA - First 3 days, given nothing}
...
#'     \item{\code{M57F}}{Antenatal care: Rural health centre/Mother child health centre}
#'     \item{\code{M57G}}{Antenatal care: BHU(Basic Health Unit)}
#'     \item{\code{M57H}}{Antenatal care: Community midwife}
...
#'     \item{\code{M57L}}{Antenatal care: Other public sector}
...
#'     \item{\code{M57Q}}{Antenatal care: Other private medical sector}
...
#'     \item{\code{M63}}{How long before discharging respondent health check took place}
...
#'     \item{\code{M67}}{How long after discharge/delivery at home respondent health check took place}
#'     \item{\code{M68}}{Who checked respondent health after discharge/delivery at home}
#'     \item{\code{M69}}{Where respondent check after discharge/delivery at home took place}
...
#'     \item{\code{M74}}{Child's health checked before discharge}
#'     \item{\code{M75}}{How long before discharging child health check took place}
#'     \item{\code{M76}}{Who checked child health before discharge}
#'     \item{\code{M77}}{Was child put on mother's chest and bare skin after birth}
#'     \item{\code{M78A}}{During first 2 days health provider: examine cord}
#'     \item{\code{M78B}}{During first 2 days health provider: measure temperature}
#'     \item{\code{M78C}}{During first 2 days health provider: counsel on newborn dangers}
#'     \item{\code{M78D}}{During first 2 days health provider: counsel on breastfeeding}
#'     \item{\code{M78E}}{During first 2 days health provider: observe breastfeeding}
#'     \item{\code{M78F}}{NA - During first 2 days health provider: CS}
#'     \item{\code{M78G}}{NA - During first 2 days health provider: CS}
#'     \item{\code{M78H}}{NA - During first 2 days health provider: CS}
#'     \item{\code{M78I}}{NA - During first 2 days health provider: CS}
#'     \item{\code{M78J}}{NA - During first 2 days health provider: CS}
#'     \item{\code{HIDX}}{Index to birth history}
#'     \item{\code{H1}}{Has health card}
#'     \item{\code{H1A}}{Has health card and or other vaccination document}
...
#'     \item{\code{H9}}{Received MEASLES 1}
#'     \item{\code{H9D}}{MEASLES 1 day}
#'     \item{\code{H9M}}{MEASLES 1 month}
#'     \item{\code{H9Y}}{MEASLES 1 year}
#'     \item{\code{H9A}}{Received MEASLES 2 (MMR)}
#'     \item{\code{H9AD}}{MEASLES 2 (MMR) day}
#'     \item{\code{H9AM}}{MEASLES 2 (MMR) month}
#'     \item{\code{H9AY}}{MEASLES 2 (MMR) year}
...
#'     \item{\code{H50}}{NA - Received Hepatitis B at birth}
#'     \item{\code{H50D}}{NA - Hepatitis B at birth day}
#'     \item{\code{H50M}}{NA - Hepatitis B at birth month}
#'     \item{\code{H50Y}}{NA - Hepatitis B at birth year}
#'     \item{\code{H51}}{Received Pentavalent 1}
#'     \item{\code{H51D}}{Pentavalent 1 day}
#'     \item{\code{H51M}}{Pentavalent 1 month}
#'     \item{\code{H51Y}}{Pentavalent 1 year}
#'     \item{\code{H52}}{Received Pentavalent 2}
#'     \item{\code{H52D}}{Pentavalent 2 day}
#'     \item{\code{H52M}}{Pentavalent 2 month}
#'     \item{\code{H52Y}}{Pentavalent 2 year}
#'     \item{\code{H53}}{Received Pentavalent 3}
#'     \item{\code{H53D}}{Pentavalent 3 day}
#'     \item{\code{H53M}}{Pentavalent 3 month}
#'     \item{\code{H53Y}}{Pentavalent 3 year}
#'     \item{\code{H54}}{Received Pneumococcal 1}
#'     \item{\code{H54D}}{Pneumococcal 1 day}
#'     \item{\code{H54M}}{Pneumococcal 1 month}
#'     \item{\code{H54Y}}{Pneumococcal 1 year}
#'     \item{\code{H55}}{Received Pneumococcal 2}
#'     \item{\code{H55D}}{Pneumococcal 2 day}
#'     \item{\code{H55M}}{Pneumococcal 2 month}
#'     \item{\code{H55Y}}{Pneumococcal 2 year}
#'     \item{\code{H56}}{Received Pneumococcal 3}
#'     \item{\code{H56D}}{Pneumococcal 3 day}
#'     \item{\code{H56M}}{Pneumococcal 3 month}
#'     \item{\code{H56Y}}{Pneumococcal 3 year}
#'     \item{\code{H57}}{NA - Received Rotavirus 1}
#'     \item{\code{H57D}}{NA - Rotavirus 1 day}
#'     \item{\code{H57M}}{NA - Rotavirus 1 month}
#'     \item{\code{H57Y}}{NA - Rotavirus 1 year}
#'     \item{\code{H58}}{NA - Received Rotavirus 2}
#'     \item{\code{H58D}}{NA - Rotavirus 2 day}
#'     \item{\code{H58M}}{NA - Rotavirus 2 month}
#'     \item{\code{H58Y}}{NA - Rotavirus 2 year}
#'     \item{\code{H59}}{NA - Received Rotavirus 3}
#'     \item{\code{H59D}}{NA - Rotavirus 3 day}
#'     \item{\code{H59M}}{NA - Rotavirus 3 month}
#'     \item{\code{H59Y}}{NA - Rotavirus 3 year}
#'     \item{\code{H60}}{Received Polio inactive}
#'     \item{\code{H60D}}{Polio inactive day}
#'     \item{\code{H60M}}{Polio inactive month}
#'     \item{\code{H60Y}}{Polio inactive year}
#'     \item{\code{H61}}{Received Hepatitis B 1}
#'     \item{\code{H61D}}{Hepatitis B 1 day}
#'     \item{\code{H61M}}{Hepatitis B 1 month}
#'     \item{\code{H61Y}}{Hepatitis B 1 year}
#'     \item{\code{H62}}{Received Hepatitis B 2}
#'     \item{\code{H62D}}{Hepatitis B 2 day}
#'     \item{\code{H62M}}{Hepatitis B 2 month}
#'     \item{\code{H62Y}}{Hepatitis B 2 year}
#'     \item{\code{H63}}{Received Hepatitis B 3}
#'     \item{\code{H63D}}{Hepatitis B 3 day}
#'     \item{\code{H63M}}{Hepatitis B 3 month}
#'     \item{\code{H63Y}}{Hepatitis B 3 year}
#'     \item{\code{H64}}{Received HiB 1}
#'     \item{\code{H64D}}{HiB 1 day}
#'     \item{\code{H64M}}{HiB 1 month}
#'     \item{\code{H64Y}}{HiB 1 year}
#'     \item{\code{H65}}{Received HiB 2}
#'     \item{\code{H65D}}{HiB 2 day}
#'     \item{\code{H65M}}{HiB 2 month}
#'     \item{\code{H65Y}}{HiB 2 year}
#'     \item{\code{H66}}{Received HiB 3}
#'     \item{\code{H66D}}{HiB 3 day}
#'     \item{\code{H66M}}{HiB 3 month}
#'     \item{\code{H66Y}}{HiB 3 year}
#'     \item{\code{H80A}}{In the last 7 days given: Baby Active (multiple micronutrient powder)}
#'     \item{\code{H80B}}{In the last 7 days given: Plumpy'NUT (ready to use therapeutic food)}
#'     \item{\code{H80C}}{In the last 7 days given: Plumpy'DOZ (ready to use supplemental food)}
#'     \item{\code{H80D}}{NA - In the last 7 days given: CS}
#'     \item{\code{H80E}}{NA - In the last 7 days given: CS}
#'     \item{\code{H80F}}{NA - In the last 7 days given: CS}
#'     \item{\code{H80G}}{NA - In the last 7 days given: CS}
#'     \item{\code{HIDXA}}{Index to birth history}
#'     \item{\code{H11}}{Had diarrhea recently}
#'     \item{\code{H11B}}{NA - Blood in the stools}
#'     \item{\code{H12A}}{Diarrhea: government hospital}
#'     \item{\code{H12B}}{Diarrhea: Rural health centre/Mother child health centre}
#'     \item{\code{H12C}}{Diarrhea: BHU(Basic Health Unit)}
#'     \item{\code{H12D}}{Diarrhea: Lady h.worker}
...
#'     \item{\code{H12V}}{Diarrhea: Community midwife}
...
#'     \item{\code{H13B}}{Given pre-packaged ORS liquid}
...
#'     \item{\code{H15D}}{Given home remedy, herbal medicine}
...
#'     \item{\code{H15K}}{NA - Given CS}
#'     \item{\code{H15L}}{NA - Given CS}
...
#'     \item{\code{H31D}}{NA - Had fever/cough in last 2 weeks: amount offered to drink}
#'     \item{\code{H31E}}{NA - Had fever/cough in last 2 weeks: amount offered to eat}
#'     \item{\code{H32A}}{Fever/cough: government hospital}
#'     \item{\code{H32B}}{Fever/cough: Rural health centre/Mother child health centre}
#'     \item{\code{H32C}}{Fever/cough: BHU(Basic Health Unit)}
#'     \item{\code{H32D}}{Fever/cough: Lady h.worker}
...
#'     \item{\code{H32K}}{Fever/cough: private pharmacy (chemist/medical store)}
...
#'     \item{\code{H32O}}{Fever/cough: Other private medical sector}
...
#'     \item{\code{H32V}}{Fever/cough: Community midwife}
...
#'     \item{\code{H37A}}{SP/Fansidar taken for fever}
#'     \item{\code{H37B}}{Chloroquine taken for fever}
#'     \item{\code{H37C}}{Amodiaquine taken for fever}
#'     \item{\code{H37D}}{Quinine taken for fever}
#'     \item{\code{H37DA}}{Quinine injection/IV taken for fever}
#'     \item{\code{H37E}}{Combination with artemisinin taken for fever}
#'     \item{\code{H37AA}}{Artesunate rectal taken for fever}
#'     \item{\code{H37AB}}{Artesunate injection/IV taken for fever}
#'     \item{\code{H37F}}{NA - CS antimalarial taken for fever}
#'     \item{\code{H37G}}{NA - CS antimalarial taken for fever}
#'     \item{\code{H37H}}{Other antimalarial taken for fever}
#'     \item{\code{H37I}}{Antibiotic pill/syrup taken for fever}
#'     \item{\code{H37J}}{Antibiotic injection taken for fever}
#'     \item{\code{H37K}}{NA - Aspirin taken for fever}
#'     \item{\code{H37L}}{Acetaminophen/paracetamol/panadol taken for fever}
#'     \item{\code{H37M}}{Ibuprofen taken for fever}
#'     \item{\code{H37N}}{Ponstan taken for fever/cough}
#'     \item{\code{H37O}}{Cough syrup taken for fever/cough}
#'     \item{\code{H37P}}{NA - CS other for fever/cough}
#'     \item{\code{H37X}}{Other taken for fever}
#'     \item{\code{H37Y}}{Nothing taken and didn't seek treatment for fever/cough}
#'     \item{\code{H37Z}}{Don't know if or what was taken for fever}
...
#'     \item{\code{H44A}}{Place first sought treatment for diarrhea}
...
#'     \item{\code{H46A}}{Place first sought treatment for fever}
#'     \item{\code{H46B}}{Number of days after fever began sought advice or treatment}
#'     \item{\code{H47}}{NA - Blood taken from child's finger/heel for testing}
...
#'     \item{\code{ML0}}{Type of mosquito bed net(s) child slept under last night}
#'     \item{\code{ML1}}{NA - Number of times took fansidar during pregnancy}
#'     \item{\code{ML2}}{NA - Source of antimalarial during pregnancy}
#'     \item{\code{ML11}}{NA - Child has fever/cough now}
#'     \item{\code{ML12}}{NA - Child has had convulsions in last 2 weeks}
#'     \item{\code{ML13A}}{Fansidar taken for fever}
#'     \item{\code{ML13B}}{Chloroquine taken for fever}
#'     \item{\code{ML13C}}{Amodiaquine taken for fever}
#'     \item{\code{ML13D}}{Quinine taken for fever}
#'     \item{\code{ML13DA}}{Quinine injection/IV taken for fever}
#'     \item{\code{ML13E}}{Combination with artemisinin taken for fever}
#'     \item{\code{ML13AA}}{Artesunate rectal taken for fever}
#'     \item{\code{ML13AB}}{Artesunate injection/IV taken for fever}
#'     \item{\code{ML13F}}{NA - CS antimalarial taken for fever}
#'     \item{\code{ML13G}}{NA - CS antimalarial taken for fever}
#'     \item{\code{ML13H}}{Other antimalarial taken for fever}
#'     \item{\code{ML13I}}{Antibiotic pill/syrup taken for fever}
#'     \item{\code{ML13J}}{Antibiotic injection taken for fever}
#'     \item{\code{ML13K}}{NA - Aspirin taken for fever}
#'     \item{\code{ML13L}}{Acetaminophen/paracetamol/panadol taken for fever}
#'     \item{\code{ML13M}}{Ibuprofen taken for fever}
#'     \item{\code{ML13N}}{Ponstan taken for fever}
#'     \item{\code{ML13O}}{Cough syrup taken for fever}
#'     \item{\code{ML13P}}{NA - CS other taken for fever}
#'     \item{\code{ML13X}}{Other taken for fever}
#'     \item{\code{ML13Y}}{Nothing taken and didn't seek treatment for fever/cough}
#'     \item{\code{ML13Z}}{Don't know if or what was taken for fever}
#'     \item{\code{ML14A}}{NA - Injection given for fever/convulsion}
#'     \item{\code{ML14B}}{NA - Suppository given for fever/convulsion}
#'     \item{\code{ML14Y}}{NA - No suppository or injection given for fever/convulsion}
#'     \item{\code{ML14Z}}{NA - Don't know if suppository or injection given for fever/convulsion}
#'     \item{\code{ML15A}}{NA - Timing of start of fansidar}
#'     \item{\code{ML15B}}{NA - Number of days child took fansidar}
#'     \item{\code{ML15C}}{NA - First source for fansidar}
#'     \item{\code{ML16A}}{NA - Timing of start of chloroquine}
#'     \item{\code{ML16B}}{NA - Number of days child took chloroquine}
#'     \item{\code{ML16C}}{NA - First source for chloroquine}
#'     \item{\code{ML17A}}{NA - Timing of start of amodiaquine}
#'     \item{\code{ML17B}}{NA - Number of days child took amodiaquine}
#'     \item{\code{ML17C}}{NA - First source for amodiaquine}
#'     \item{\code{ML18A}}{NA - Timing of start of quinine}
#'     \item{\code{ML18B}}{NA - Number of days child took quinine}
#'     \item{\code{ML18C}}{NA - First source for quinine}
#'     \item{\code{ML19A}}{NA - For fever/convulsion: consulted traditional healer}
#'     \item{\code{ML19B}}{NA - For fever/convulsion: gave tepid sponging}
#'     \item{\code{ML19C}}{NA - For fever/convulsion: gave herbs}
#'     \item{\code{ML19D}}{NA - For fever/convulsion: CS}
#'     \item{\code{ML19E}}{NA - For fever/convulsion: CS}
#'     \item{\code{ML19F}}{NA - For fever/convulsion: CS}
#'     \item{\code{ML19X}}{NA - For fever/convulsion: other}
#'     \item{\code{ML19Y}}{NA - For fever/convulsion: gave/did nothing}
#'     \item{\code{ML19Z}}{NA - For fever/convulsion: don't know if something else was done}
#'     \item{\code{ML20A}}{NA - Timing of start of combination with artemisinin}
#'     \item{\code{ML20B}}{NA - Number of days child took combination with artemisinin}
#'     \item{\code{ML20C}}{NA - First source for combination with artemisinin}
#'     \item{\code{ML21A}}{NA - Timing of start of CS antimalarial use}
#'     \item{\code{ML21B}}{NA - Number of days child took CS antimalarial}
#'     \item{\code{ML21C}}{NA - First source for CS antimalarial}
#'     \item{\code{ML22A}}{NA - Timing of start of CS antimalarial use}
#'     \item{\code{ML22B}}{NA - Number of days child took CS antimalarial}
#'     \item{\code{ML22C}}{NA - First source for CS antimalarial}
#'     \item{\code{ML23A}}{NA - Timing of start of other anti-malarial use}
#'     \item{\code{ML23B}}{NA - Number of days child took other anti-malarial}
#'     \item{\code{ML23C}}{NA - First source for other anti-malarial}
#'     \item{\code{ML24C}}{NA - First source for antibiotic pill/syrup}
#'     \item{\code{ML25A}}{NA - Timing of start of artesunate}
...
#'     \item{\code{S409A}}{Satisfied with service provided}
#'     \item{\code{S413AA}}{During antenatal care advised on: Early breastfeeding}
#'     \item{\code{S413AB}}{During antenatal care advised on: Exclusive breastfeeding}
#'     \item{\code{S413AC}}{During antenatal care advised on: Balanced diet}
#'     \item{\code{S437A}}{Talked about using FP method when was in facility}
#'     \item{\code{S443A}}{Talked about using FP method after left facility}
#'     \item{\code{S451A}}{Talked about using FP method when delivery was at home or other place non private/public}
#'     \item{\code{S469A}}{Reason stop breastfeeding}
#'
#'   }
#'
#' @author
